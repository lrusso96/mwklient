...
mwklient: lightweight MediaWiki client
======================================
...
mwklient is a :ref:`MIT licensed <license>` client library to the `MediaWiki API`_
...
Installing mwklient is simple with `pip <https://pip.pypa.io>`_, just run
...
.. code-block:: python
    ...
    >>> site = mwklient.Site(('https', 'en.wikipedia.org'))
