...
where ``file`` is now an instance of :class:`Image <mwklient.image.Image>`
...
See the :class:`API reference <mwklient.image.Image>` for more options.
...
The :meth:`Image.download() <mwklient.image.Image.download>` method can be used to download
